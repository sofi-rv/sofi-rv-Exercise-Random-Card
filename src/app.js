...
window.onload = function() {
  ...
  newDiv.classList.add("container", "bg", "bg-light");
  newDiv.innerHTML = `<div class="row symbol heading">Fila 1<div/><div class="row number">Fila 2<div/><div class="row symbol reverse">Fila 3<div/>`;
